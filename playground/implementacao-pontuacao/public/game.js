...
export default function createGame() {
    ...
    function movePlayer(command) {
        ...
        const acceptedMoves = { //nova funcionalidade q faz, por exemplo, esse objeto (acceptedMoves) ter como keys: ArrowUp, ArrowRight...  e vai ter como value para essa Keys as respectibas funções!
            ArrowUp(player) {
